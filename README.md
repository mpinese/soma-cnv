...
```bash
util/cram2ad data/truseq_nano_hiseqX_hs37d5x.loci.tsv <reference.fa> sampleID.cram | xz -c > sampleID.soma-cnv.hetdp.xz
```
This tool requires the [hts-nim](https://github.com/brentp/hts-nim) and [docopt](https://github.com/docopt/docopt.nim) libraries, and can be compiled using `nim c -d:release cram2ad.nim`.
